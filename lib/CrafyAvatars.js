...
// JavaScript version of CrafyAvatars

function CrafyAvatars_addZeroToStart(number) {
    let result;
...
function CrafyAvatars_getRandomInt(min, max) {
...
class CrafyAvatars {
    ...
    constructor() {
        ...
        this.shapes_end_key = shapesAmount;
        this.colors_end_key = themesAmount;

        this.svgStart = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 231 231">';
        this.svgEnd = '</svg>';

        this.env = '<path d="M33.83,33.83a115.5,115.5,0,1,1,0,163.34,115.49,115.49,0,0,1,0-163.34Z" style="fill:#01;"/>';
        this.head = '<path d="m115.5 51.75a63.75 63.75 0 0 0-10.5 126.63v14.09a115.5 115.5 0 0 0-53.729 19.027 115.5 115.5 0 0 0 128.46 0 115.5 115.5 0 0 0-53.729-19.029v-14.084a63.75 63.75 0 0 0 53.25-62.881 63.75 63.75 0 0 0-63.65-63.75 63.75 63.75 0 0 0-0.09961 0z" style="fill:#000;"/>';

        this.themes = {};
        this.shapes = {};

        for (let i = 0; i <= shapesAmount; i++) {
            this.shapes[CrafyAvatars_addZeroToStart(i)] = {};
            this.themes[CrafyAvatars_addZeroToStart(i)] = {};
            for (let t = 0; t <= themesAmount; t++) {
                this.themes[CrafyAvatars_addZeroToStart(i)][CrafyAvatars_addZeroToStart(t)] = {};
            }
        }
        ...
        // Robo
        this.themes['00']['00']['env'] = ["#ff2f2b"];
        this.themes['00']['00']['clo'] = ["#fff", "#000"];
        this.themes['00']['00']['head'] = ["#fff"];
        this.themes['00']['00']['mouth'] = ["#fff", "#000", "#000"];
        this.themes['00']['00']['eyes'] = ["#000", "none", "#00FFFF"];
        this.themes['00']['00']['top'] = ["#fff", "#fff"];

        this.themes['00']['01']['env'] = ["#ff1ec1"];
        this.themes['00']['01']['clo'] = ["#000", "#fff"];
        this.themes['00']['01']['head'] = ["#ffc1c1"];
        this.themes['00']['01']['mouth'] = ["#fff", "#515151", "#515151"];
        this.themes['00']['01']['eyes'] = ["#FF2D00", "#fff", "none"];
        this.themes['00']['01']['top'] = ["#a21d00", "#fff"];

        this.themes['00']['02']['env'] = ["#0079b1"];
        this.themes['00']['02']['clo'] = ["#0e00b1", "#d1fffe"];
        this.themes['00']['02']['head'] = ["#f5aa77"];
        this.themes['00']['02']['mouth'] = ["#fff", "#EE12F1", "#EE12F1"];
        this.themes['00']['02']['eyes'] = ["#0c00de", "#fff", "none"];
        this.themes['00']['02']['top'] = ["#acfffd", "#acfffd"];

        this.themes['00']['03']['env'] = ["#CF1FE7"];
        this.themes['00']['03']['clo'] = ["#00B666", "#8673F1"];
        this.themes['00']['03']['head'] = ["#f5aa78"];
        this.themes['00']['03']['mouth'] = ["#fff", "#0300DA", "#0300DA"];
        this.themes['00']['03']['eyes'] = ["#00C6DE", "#000", "none"];
        this.themes['00']['03']['top'] = ["#C2EF6E", "#C2EF6E"];

        // Girl
        this.themes['01']['00']['env'] = ["#a50000"];
        this.themes['01']['00']['clo'] = ["#f06", "#8e0039"];
        this.themes['01']['00']['head'] = ["#85492C"];
        this.themes['01']['00']['mouth'] = ["#000"];
        this.themes['01']['00']['eyes'] = ["#000", "#ff9809"];
        this.themes['01']['00']['top'] = ["#ff9809", "#ff9809", "none", "none"];

        this.themes['01']['01']['env'] = ["#40E83B"];
        this.themes['01']['01']['clo'] = ["#00650b", "#62ce5a"];
        this.themes['01']['01']['head'] = ["#f7c1a6"];
        this.themes['01']['01']['mouth'] = ["#6e1c1c"];
        this.themes['01']['01']['eyes'] = ["#000", "#ff833b"];
        this.themes['01']['01']['top'] = ["#67FFCC", "none", "none", "#ecff3b"];

        this.themes['01']['02']['env'] = ["#ff2c2c"];
        this.themes['01']['02']['clo'] = ["#fff", "#000"];
        this.themes['01']['02']['head'] = ["#ffce8b"];
        this.themes['01']['02']['mouth'] = ["#E31B1B"];
        this.themes['01']['02']['eyes'] = ["#000", "#0072ff"];
        this.themes['01']['02']['top'] = ["#ff9809", "none", "#ffc809", "none"];

        this.themes['01']['03']['env'] = ["#00E397"];
        this.themes['01']['03']['clo'] = ["#E30094", "#fff"];
        this.themes['01']['03']['head'] = ["#ffce8b"];
        this.themes['01']['03']['mouth'] = ["#E31BDA"];
        this.themes['01']['03']['eyes'] = ["#000", "#7C1BE3"];
        this.themes['01']['03']['top'] = ["#684112", "none", "#8F5510", "none"];

        // Blonde
        this.themes['02']['00']['env'] = ["#ff7520"];
        this.themes['02']['00']['clo'] = ["#d12823"];
        this.themes['02']['00']['head'] = ["#fee3c5"];
        this.themes['02']['00']['mouth'] = ["#d12823"];
        this.themes['02']['00']['eyes'] = ["#000", "none"];
        this.themes['02']['00']['top'] = ["#000", "none", "none", "#FFCC00", "red"];

        this.themes['02']['01']['env'] = ["#ff9700"];
        this.themes['02']['01']['clo'] = ["#000"];
        this.themes['02']['01']['head'] = ["#d2ad6d"];
        this.themes['02']['01']['mouth'] = ["#000"];
        this.themes['02']['01']['eyes'] = ["#000", "#00ffdc"];
        this.themes['02']['01']['top'] = ["#fdff00", "#fdff00", "none", "none", "none"];

        this.themes['02']['02']['env'] = ["#26a7ff"];
        this.themes['02']['02']['clo'] = ["#d85cd7"];
        this.themes['02']['02']['head'] = ["#542e02"];
        this.themes['02']['02']['mouth'] = ["#f70014"];
        this.themes['02']['02']['eyes'] = ["#000", "magenta"];
        this.themes['02']['02']['top'] = ["#FFCC00", "#FFCC00", "#FFCC00", "#ff0000", "yellow"];

        this.themes['02']['03']['env'] = ["#00C1FF"];
        this.themes['02']['03']['clo'] = ["#E60A7C"];
        this.themes['02']['03']['head'] = ["#542e02"];
        this.themes['02']['03']['mouth'] = ["#B923D1"];
        this.themes['02']['03']['eyes'] = ["#C6E1E5", "#000"];
        this.themes['02']['03']['top'] = ["#FFDB14", "#FFDB14", "#FFDB14", "none", "none"];

        // Evilnormie
        this.themes['03']['00']['env'] = ["#6FC30E"];
        this.themes['03']['00']['clo'] = ["#b4e1fa", "#5b5d6e", "#515262", "#a0d2f0", "#a0d2f0"];
        this.themes['03']['00']['head'] = ["#fae3b9"];
        this.themes['03']['00']['mouth'] = ["#fff", "#000"];
        this.themes['03']['00']['eyes'] = ["#000"];
        this.themes['03']['00']['top'] = ["#8eff45", "#8eff45", "none", "none"];

        this.themes['03']['01']['env'] = ["#00a58c"];
        this.themes['03']['01']['clo'] = ["#000", "none", "none", "none", "none"];
        this.themes['03']['01']['head'] = ["#FAD2B9"];
        this.themes['03']['01']['mouth'] = ["#fff", "#003381"];
        this.themes['03']['01']['eyes'] = ["#003381"];
        this.themes['03']['01']['top'] = ["#FFC600", "none", "#FFC600", "none"];

        this.themes['03']['02']['env'] = ["#ff501f"];
        this.themes['03']['02']['clo'] = ["#000", "#ff0000", "#ff0000", "#7d7d7d", "#7d7d7d"];
        this.themes['03']['02']['head'] = ["#fff3dc"];
        this.themes['03']['02']['mouth'] = ["#d2001b", "none"];
        this.themes['03']['02']['eyes'] = ["#00F3FF"];
        this.themes['03']['02']['top'] = ["#D2001B", "none", "none", "#D2001B"];

        this.themes['03']['03']['env'] = ["#530DF4"];
        this.themes['03']['03']['clo'] = ["#585858", "#236dd8", "#236dd8", "#fff", "#fff"];
        this.themes['03']['03']['head'] = ["#fff3dc"];
        this.themes['03']['03']['mouth'] = ["#cd7a85", "none"];
        this.themes['03']['03']['eyes'] = ["#433A1F"];
        this.themes['03']['03']['top'] = ["#A21FED", "#A21FED", "none", "#A21FED"];

        // Country
        this.themes['04']['00']['env'] = ["#fc0"];
        this.themes['04']['00']['clo'] = ["#901e0e", "#ffbe1e", "#ffbe1e", "#c55f54"];
        this.themes['04']['00']['head'] = ["#f8d9ad"];
        this.themes['04']['00']['mouth'] = ["#000", "none", "#000", "none"];
        this.themes['04']['00']['eyes'] = ["#000"];
        this.themes['04']['00']['top'] = ["#583D00", "#AF892E", "#462D00", "#a0a0a0"];

        this.themes['04']['01']['env'] = ["#386465"];
        this.themes['04']['01']['clo'] = ["#fff", "#333", "#333", "#333"];
        this.themes['04']['01']['head'] = ["#FFD79D"];
        this.themes['04']['01']['mouth'] = ["#000", "#000", "#000", "#000"];
        this.themes['04']['01']['eyes'] = ["#003381"];
        this.themes['04']['01']['top'] = ["#27363C", "#5DCAD4", "#314652", "#333"];

        this.themes['04']['02']['env'] = ["#DFFF00"];
        this.themes['04']['02']['clo'] = ["#304267", "#aab0b1", "#aab0b1", "#aab0b1"];
        this.themes['04']['02']['head'] = ["#e6b876"];
        this.themes['04']['02']['mouth'] = ["#50230a", "#50230a", "#50230a", "#50230a"];
        this.themes['04']['02']['eyes'] = ["#00F3FF"];
        this.themes['04']['02']['top'] = ["#333", "#afafaf", "#222", "#6d3a1d"];

        this.themes['04']['03']['env'] = ["#FF7800"];
        this.themes['04']['03']['clo'] = ["#167E50", "#ffbe1e", "#ffbe1e", "#aab0b1"];
        this.themes['04']['03']['head'] = ["#e6b876"];
        this.themes['04']['03']['mouth'] = ["#F0D300", "#F0D300", "#F0D300", "#F0D300"];
        this.themes['04']['03']['eyes'] = ["#765B2A"];
        this.themes['04']['03']['top'] = ["#08DB7B", "#000", "#08BA69", "#FAF0BE"];

        // Johnyold
        this.themes['05']['00']['env'] = ["#a09300"];
        this.themes['05']['00']['clo'] = ["#c7d4e2", "#435363", "#435363", "#141720", "#141720", "#e7ecf2", "#e7ecf2"];
        this.themes['05']['00']['head'] = ["#f5d4a6"];
        this.themes['05']['00']['mouth'] = ["#5E5E5E", "#CC8A51"];
        this.themes['05']['00']['eyes'] = ["#000", "#000", "#000", "#000", "#000", "#000", "#fff", "#fff", "#fff", "#fff", "#000", "#000"];
        this.themes['05']['00']['top'] = ["none", "#fdff00"];

        this.themes['05']['01']['env'] = ["#b3003e"];
        this.themes['05']['01']['clo'] = ["#000", "#435363", "#435363", "#000", "none", "#e7ecf2", "#e7ecf2"];
        this.themes['05']['01']['head'] = ["#f5d4a6"];
        this.themes['05']['01']['mouth'] = ["#000", "#af9f94"];
        this.themes['05']['01']['eyes'] = ["#9ff3ff;opacity:0.96", "#000", "#9ff3ff;opacity:0.96", "#000", "#2f508a", "#000", "#000", "#000", "none", "none", "none", "none"];
        this.themes['05']['01']['top'] = ["#ff9a00", "#ff9a00"];

        this.themes['05']['02']['env'] = ["#884f00"];
        this.themes['05']['02']['clo'] = ["#ff0000", "#fff", "#fff", "#141720", "#141720", "#e7ecf2", "#e7ecf2"];
        this.themes['05']['02']['head'] = ["#c57b14"];
        this.themes['05']['02']['mouth'] = ["#0015E7", "#cf9f76"];
        this.themes['05']['02']['eyes'] = ["none", "#000", "none", "#000", "#5a0000", "#000", "#000", "#000", "none", "none", "none", "none"];
        this.themes['05']['02']['top'] = ["#efefef", "none"];

        this.themes['05']['03']['env'] = ["#A7CD0C"];
        this.themes['05']['03']['clo'] = ["#1F00FF", "#FFA200", "#FFAA00", "#78FF00", "#78FF00", "#949B8E", "#949B8E"];
        this.themes['05']['03']['head'] = ["#c57b14"];
        this.themes['05']['03']['mouth'] = ["#2C2C2C", "#FF7500"];
        this.themes['05']['03']['eyes'] = ["none", "#E91111", "none", "#E91111", "#000", "#E91111", "#E91111", "#E91111", "none", "none", "none", "none"];
        this.themes['05']['03']['top'] = ["#CBCBCB", "#CBCBCB"];

        // Asian
        this.themes['06']['00']['env'] = ["#8acf00"];
        this.themes['06']['00']['clo'] = ["#ee2829", "#ff0"];
        this.themes['06']['00']['head'] = ["#ffce73"];
        this.themes['06']['00']['mouth'] = ["#fff", "#000"];
        this.themes['06']['00']['eyes'] = ["#000"];
        this.themes['06']['00']['top'] = ["#000", "#000", "none", "#000", "#ff4e4e", "#000"];

        this.themes['06']['01']['env'] = ["#00d2a3"];
        this.themes['06']['01']['clo'] = ["#0D0046", "#ffce73"];
        this.themes['06']['01']['head'] = ["#ffce73"];
        this.themes['06']['01']['mouth'] = ["#000", "none"];
        this.themes['06']['01']['eyes'] = ["#00FFF3"];
        this.themes['06']['01']['top'] = ["#000", "#000", "#000", "none", "#ffb358", "#000", "none", "none"];

        this.themes['06']['02']['env'] = ["#ff184e"];
        this.themes['06']['02']['clo'] = ["#000", "none"];
        this.themes['06']['02']['head'] = ["#ffce73"];
        this.themes['06']['02']['mouth'] = ["#ff0000", "none"];
        this.themes['06']['02']['eyes'] = ["#0011BC"];
        this.themes['06']['02']['top'] = ["none", "none", "none", "none", "none", "#ffc107", "none", "none"];

        this.themes['06']['03']['env'] = ["#00CDF2"];
        this.themes['06']['03']['clo'] = ["#000", "#F70000"];
        this.themes['06']['03']['head'] = ["#ffce73"];
        this.themes['06']['03']['mouth'] = ["#000", "#CA00F7"];
        this.themes['06']['03']['eyes'] = ["#6D0085"];
        this.themes['06']['03']['top'] = ["#FFCE07", "#FFCE07", "none", "none", "none", "#FFCE07", "none", "none"];

        // Punk
        this.themes['07']['00']['env'] = ["#00deae"];
        this.themes['07']['00']['clo'] = ["#ff0000"];
        this.themes['07']['00']['head'] = ["#ffce94"];
        this.themes['07']['00']['mouth'] = ["#f73b6c", "#000"];
        this.themes['07']['00']['eyes'] = ["#e91e63", "#000", "#e91e63", "#000", "#000", "#000"];
        this.themes['07']['00']['top'] = ["#dd104f", "#dd104f", "#f73b6c", "#dd104f"];

        this.themes['07']['01']['env'] = ["#181284"];
        this.themes['07']['01']['clo'] = ["#491f49", "#ff9809", "#491f49"];
        this.themes['07']['01']['head'] = ["#f6ba97"];
        this.themes['07']['01']['mouth'] = ["#ff9809", "#000"];
        this.themes['07']['01']['eyes'] = ["#c4ffe4", "#000", "#c4ffe4", "#000", "#000", "#000"];
        this.themes['07']['01']['top'] = ["none", "none", "#d6f740", "#516303"];

        this.themes['07']['02']['env'] = ["#bcf700"];
        this.themes['07']['02']['clo'] = ["#ff14e4", "#000", "#14fffd"];
        this.themes['07']['02']['head'] = ["#7b401e"];
        this.themes['07']['02']['mouth'] = ["#666", "#000"];
        this.themes['07']['02']['eyes'] = ["#00b5b4", "#000", "#00b5b4", "#000", "#000", "#000"];
        this.themes['07']['02']['top'] = ["#14fffd", "#14fffd", "#14fffd", "#0d3a62"];

        this.themes['07']['03']['env'] = ["#F86D00"];
        this.themes['07']['03']['clo'] = ["#00F887", "#fff", "#000"];
        this.themes['07']['03']['head'] = ["#7b401e"];
        this.themes['07']['03']['mouth'] = ["#56430E", "#1A1A1A"];
        this.themes['07']['03']['eyes'] = ["#9B6C00", "#006FED", "#9B6C00", "#006FED", "#006FED", "#006FED"];
        this.themes['07']['03']['top'] = ["#633a34", "#633a34", "#633a34", "#C600F7"];

        // Afrohair
        this.themes['08']['00']['env'] = ["#0df"];
        this.themes['08']['00']['clo'] = ["#571e57", "#ff0"];
        this.themes['08']['00']['head'] = ["#f2c280"];
        this.themes['08']['00']['mouth'] = ["#ff0000"];
        this.themes['08']['00']['eyes'] = ["#795548", "#000"];
        this.themes['08']['00']['top'] = ["#de3b00", "none"];

        this.themes['08']['01']['env'] = ["#B400C2"];
        this.themes['08']['01']['clo'] = ["#0D204A", "#00ffdf"];
        this.themes['08']['01']['head'] = ["#ca8628"];
        this.themes['08']['01']['mouth'] = ["#1a1a1a"];
        this.themes['08']['01']['eyes'] = ["#cbbdaf", "#000"];
        this.themes['08']['01']['top'] = ["#000", "#000"];

        this.themes['08']['02']['env'] = ["#ffe926"];
        this.themes['08']['02']['clo'] = ["#00d6af", "#000"];
        this.themes['08']['02']['head'] = ["#8c5100"];
        this.themes['08']['02']['mouth'] = ["#7d0000"];
        this.themes['08']['02']['eyes'] = ["none", "#000"];
        this.themes['08']['02']['top'] = ["#f7f7f7", "none"];

        this.themes['08']['03']['env'] = ["#00A6FF"];
        this.themes['08']['03']['clo'] = ["#FF0049", "#fff"];
        this.themes['08']['03']['head'] = ["#8c5100"];
        this.themes['08']['03']['mouth'] = ["#E52424"];
        this.themes['08']['03']['eyes'] = ["#5B3F3B", "#000"];
        this.themes['08']['03']['top'] = ["#5B3F3B", "none"];

        // Normie female
        this.themes['09']['00']['env'] = ["#4aff0c"];
        this.themes['09']['00']['clo'] = ["#101010", "#fff", "#fff"];
        this.themes['09']['00']['head'] = ["#dbbc7f"];
        this.themes['09']['00']['mouth'] = ["#000"];
        this.themes['09']['00']['eyes'] = ["#000", "none", "none"];
        this.themes['09']['00']['top'] = ["#531148", "#531148", "#531148", "none"];

        this.themes['09']['01']['env'] = ["#FFC107"];
        this.themes['09']['01']['clo'] = ["#033c58", "#fff", "#fff"];
        this.themes['09']['01']['head'] = ["#dbc97f"];
        this.themes['09']['01']['mouth'] = ["#EA1212"];
        this.themes['09']['01']['eyes'] = ["none", "#00FFFB", "#000"];
        this.themes['09']['01']['top'] = ["#FFEB3B", "#FFEB3B", "none", "#FFEB3B"];

        this.themes['09']['02']['env'] = ["#FF9800"];
        this.themes['09']['02']['clo'] = ["#b40000", "#fff", "#fff"];
        this.themes['09']['02']['head'] = ["#E2AF6B"];
        this.themes['09']['02']['mouth'] = ["#E712EA"];
        this.themes['09']['02']['eyes'] = ["none", "#fff", "#000"];
        this.themes['09']['02']['top'] = ["#ec0000", "#ec0000", "none", "none"];

        this.themes['09']['03']['env'] = ["#FF00D4"];
        this.themes['09']['03']['clo'] = ["#E833CA", "#A62891", "#A62891"];
        this.themes['09']['03']['head'] = ["#E2AF6B"];
        this.themes['09']['03']['mouth'] = ["#e393b9"];
        this.themes['09']['03']['eyes'] = ["none", "#000", "#000"];
        this.themes['09']['03']['top'] = ["#633a34", "#633a34", "#633a34", "none"];

        // Older
        this.themes['10']['00']['env'] = ["#104c8c"];
        this.themes['10']['00']['clo'] = ["#354B65", "#3D8EBB", "#89D0DA", "#00FFFD"];
        this.themes['10']['00']['head'] = ["#cc9a5c"];
        this.themes['10']['00']['mouth'] = ["#222", "#fff"];
        this.themes['10']['00']['eyes'] = ["#000", "#000"];
        this.themes['10']['00']['top'] = ["#fff", "#fff", "none"];

        this.themes['10']['01']['env'] = ["#0DC15C"];
        this.themes['10']['01']['clo'] = ["#212121", "#fff", "#212121", "#fff",];
        this.themes['10']['01']['head'] = ["#dca45f"];
        this.themes['10']['01']['mouth'] = ["#111", "#633b1d"];
        this.themes['10']['01']['eyes'] = ["#000", "#0009C1"];
        this.themes['10']['01']['top'] = ["none", "#792B74", "#792B74"];

        this.themes['10']['02']['env'] = ["#ffe500"];
        this.themes['10']['02']['clo'] = ["#1e5e80", "#fff", "#1e5e80", "#fff"];
        this.themes['10']['02']['head'] = ["#e8bc86"];
        this.themes['10']['02']['mouth'] = ["#111", "none"];
        this.themes['10']['02']['eyes'] = ["#000", "#00C112"];
        this.themes['10']['02']['top'] = ["none", "none", "#633b1d"];

        this.themes['10']['03']['env'] = ["#FF0093"];
        this.themes['10']['03']['clo'] = ["#EB3911", "#000", "#EB3911", "none"];
        this.themes['10']['03']['head'] = ["#e8bc86"];
        this.themes['10']['03']['mouth'] = ["#000", "#633a34"];
        this.themes['10']['03']['eyes'] = ["#2446F0", "#00C112"];
        this.themes['10']['03']['top'] = ["#ECECEC", "none", "#ECECEC"];

        // Firehair
        this.themes['11']['00']['env'] = ["#4a3f73"];
        this.themes['11']['00']['clo'] = ["#e6e9ee", "#f1543f", "#ff7058", "#fff", "#fff"];
        this.themes['11']['00']['head'] = ["#b27e5b"];
        this.themes['11']['00']['mouth'] = ["#191919", "#191919"];
        this.themes['11']['00']['eyes'] = ["#000", "#000", "#57FFFD"];
        this.themes['11']['00']['top'] = ["#ffc", "#ffc", "#ffc"];

        this.themes['11']['01']['env'] = ["#00a08d"];
        this.themes['11']['01']['clo'] = ["#FFBA32", "#484848", "#4e4e4e", "#fff", "#fff"];
        this.themes['11']['01']['head'] = ["#ab5f2c"];
        this.themes['11']['01']['mouth'] = ["#3C3C3C", "#191919"];
        this.themes['11']['01']['eyes'] = ["#000", "#ff23fa;opacity:0.39", "#000"];
        this.themes['11']['01']['top'] = ["#ff90f4", "#ff90f4", "#ff90f4"];

        this.themes['11']['02']['env'] = ["#22535d"];
        this.themes['11']['02']['clo'] = ["#000", "#ff2500", "#ff2500", "#fff", "#fff"];
        this.themes['11']['02']['head'] = ["#a76c44"];
        this.themes['11']['02']['mouth'] = ["#191919", "#000000"];
        this.themes['11']['02']['eyes'] = ["#000", "none", "#000"];
        this.themes['11']['02']['top'] = ["none", "#00efff", "none"];

        this.themes['11']['03']['env'] = ["#00FFBD"];
        this.themes['11']['03']['clo'] = ["#14B298", "none", "none", "#fff", "#fff"];
        this.themes['11']['03']['head'] = ["#a76c44"];
        this.themes['11']['03']['mouth'] = ["#ffffff", "#000000"];
        this.themes['11']['03']['eyes'] = ["#000", "#157344", "#6C6C6C"];
        this.themes['11']['03']['top'] = ["none", "#F2E10C", "none"];

        // Blond
        this.themes['12']['00']['env'] = ["#2668DC"];
        this.themes['12']['00']['clo'] = ["#2385c6", "#b8d0e0", "#b8d0e0"];
        this.themes['12']['00']['head'] = ["#ad8a60"];
        this.themes['12']['00']['mouth'] = ["#000", "#4d4d4d"];
        this.themes['12']['00']['eyes'] = ["#7fb5a2", "#d1eddf", "#301e19"];
        this.themes['12']['00']['top'] = ["#fff510", "#fff510"];

        this.themes['12']['01']['env'] = ["#643869"];
        this.themes['12']['01']['clo'] = ["#D67D1B", "#b8d0e0", "#b8d0e0"];
        this.themes['12']['01']['head'] = ["#CC985A", "none0000"];
        this.themes['12']['01']['mouth'] = ["#000", "#ececec"];
        this.themes['12']['01']['eyes'] = ["#1f2644", "#9b97ce", "#301e19"];
        this.themes['12']['01']['top'] = ["#00eaff", "none"];

        this.themes['12']['02']['env'] = ["#F599FF"];
        this.themes['12']['02']['clo'] = ["#2823C6", "#b8d0e0", "#b8d0e0"];
        this.themes['12']['02']['head'] = ["#C7873A"];
        this.themes['12']['02']['mouth'] = ["#000", "#2B2B2B"];
        this.themes['12']['02']['eyes'] = ["#581b1b", "#FF8B8B", "#000"];
        this.themes['12']['02']['top'] = ["none", "#9c0092"];

        this.themes['12']['03']['env'] = ["#0080FF"];
        this.themes['12']['03']['clo'] = ["#E81BE8", "#A7196D", "#A7196D"];
        this.themes['12']['03']['head'] = ["#C7873A"];
        this.themes['12']['03']['mouth'] = ["#000", "#633a34"];
        this.themes['12']['03']['eyes'] = ["#0D699A", "#12A1EE", "#000"];
        this.themes['12']['03']['top'] = ["none", "#DAD103"];

        // Ateam
        this.themes['13']['00']['env'] = ["#d10084"];
        this.themes['13']['00']['clo'] = ["#efedee", "#00a1e0", "#00a1e0", "#efedee", "#ffce1c"];
        this.themes['13']['00']['head'] = ["#b35f49"];
        this.themes['13']['00']['mouth'] = ["#3a484a", "#000"];
        this.themes['13']['00']['eyes'] = ["#000"];
        this.themes['13']['00']['top'] = ["#000", "none", "#000", "none"];

        this.themes['13']['01']['env'] = ["#E6C117"];
        this.themes['13']['01']['clo'] = ["#efedee", "#ec0033", "#ec0033", "#efedee", "#f2ff05"];
        this.themes['13']['01']['head'] = ["#ffc016"];
        this.themes['13']['01']['mouth'] = ["#4a3737", "#000"];
        this.themes['13']['01']['eyes'] = ["#10F4FF"];
        this.themes['13']['01']['top'] = ["#ffe900", "#ffe900", "none", "#ffe900"];

        this.themes['13']['02']['env'] = ["#1d8c00"];
        this.themes['13']['02']['clo'] = ["#e000cb", "#fff", "#fff", "#e000cb", "#ffce1c"];
        this.themes['13']['02']['head'] = ["#b96438"];
        this.themes['13']['02']['mouth'] = ["#000", "#000"];
        this.themes['13']['02']['eyes'] = ["#0000D3"];
        this.themes['13']['02']['top'] = ["#53ffff", "#53ffff", "none", "none"];

        this.themes['13']['03']['env'] = ["#FFCD00"];
        this.themes['13']['03']['clo'] = ["#B9106F", "#10B95A", "#10B95A", "#B9106F", "#19FFFD"];
        this.themes['13']['03']['head'] = ["#b96438"];
        this.themes['13']['03']['mouth'] = ["#633a34", "#000"];
        this.themes['13']['03']['eyes'] = ["#BD42FF"];
        this.themes['13']['03']['top'] = ["#633a34", "#633a34", "#633a34", "none"];

        // Rasta
        this.themes['14']['00']['env'] = ["#fc0065"];
        this.themes['14']['00']['clo'] = ["#708913", "#fdea14", "#708913", "#fdea14", "#708913"];
        this.themes['14']['00']['head'] = ["#DEA561"];
        this.themes['14']['00']['mouth'] = ["#444", "#000"];
        this.themes['14']['00']['eyes'] = ["#000"];
        this.themes['14']['00']['top'] = ["#32393f", "#32393f", "#32393f", "#32393f", "#32393f", "#32393f", "#32393f", "#32393f", "#32393f", "#32393f", "#32393f", "#32393f", "#32393f", "#32393f", "#32393f", "#32393f", "#32393f"];

        this.themes['14']['01']['env'] = ["#81f72e"];
        this.themes['14']['01']['clo'] = ["#ff0000", "#ffc107", "#ff0000", "#ffc107", "#ff0000"];
        this.themes['14']['01']['head'] = ["#ef9831"];
        this.themes['14']['01']['mouth'] = ["#6b0000", "#000"];
        this.themes['14']['01']['eyes'] = ["#10F4FF"];
        this.themes['14']['01']['top'] = ["#FFFAAD", "#FFFAAD", "#FFFAAD", "#FFFAAD", "#FFFAAD", "#FFFAAD", "#FFFAAD", "#FFFAAD", "#FFFAAD", "#FFFAAD", "#FFFAAD", "#FFFAAD", "#FFFAAD", "none", "none", "none", "none"];

        this.themes['14']['02']['env'] = ["#00D872"];
        this.themes['14']['02']['clo'] = ["#590D00", "#FD1336", "#590D00", "#FD1336", "#590D00"];
        this.themes['14']['02']['head'] = ["#c36c00"];
        this.themes['14']['02']['mouth'] = ["#56442b", "#000"];
        this.themes['14']['02']['eyes'] = ["#0000D3"];
        this.themes['14']['02']['top'] = ["#004E4C", "#004E4C", "#004E4C", "#004E4C", "#004E4C", "#004E4C", "#004E4C", "#004E4C", "#004E4C", "none", "none", "none", "none", "none", "none", "none", "none"];

        this.themes['14']['03']['env'] = ["#A600FF"];
        this.themes['14']['03']['clo'] = ["#1B822D", "#553BCE", "#1B822D", "#553BCE", "#1B822D"];
        this.themes['14']['03']['head'] = ["#c36c00"];
        this.themes['14']['03']['mouth'] = ["#F5F5F5", "#000"];
        this.themes['14']['03']['eyes'] = ["#535353"];
        this.themes['14']['03']['top'] = ["#633a34", "#633a34", "#633a34", "#633a34", "#633a34", "#633a34", "#633a34", "#633a34", "#633a34", "none", "none", "none", "none", "none", "none", "none", "none"];

        // Meta
        this.themes['15']['00']['env'] = ["#111"];
        this.themes['15']['00']['clo'] = ["#000", "#00FFFF"];
        this.themes['15']['00']['head'] = ["#755227"];
        this.themes['15']['00']['mouth'] = ["#fff", "#000"];
        this.themes['15']['00']['eyes'] = ["black", "#008;opacity:0.67", "aqua"];
        this.themes['15']['00']['top'] = ["#fff", "#fff", "#fff", "#fff", "#fff"];

        this.themes['15']['01']['env'] = ["#00D0D4"];
        this.themes['15']['01']['clo'] = ["#000", "#fff"];
        this.themes['15']['01']['head'] = ["#755227"];
        this.themes['15']['01']['mouth'] = ["#fff", "#2D2D2D"];
        this.themes['15']['01']['eyes'] = ["black", "#1df7ff;opacity:0.64", "#fcff2c"];
        this.themes['15']['01']['top'] = ["#fff539", "none", "#fff539", "none", "#fff539"];

        this.themes['15']['02']['env'] = ["#DC75FF"];
        this.themes['15']['02']['clo'] = ["#000", "#FFBDEC"];
        this.themes['15']['02']['head'] = ["#997549"];
        this.themes['15']['02']['mouth'] = ["#EAEAEA", "#000"];
        this.themes['15']['02']['eyes'] = ["black", "black", "aqua"];
        this.themes['15']['02']['top'] = ["#00fffd", "none", "none", "none", "none"];

        this.themes['15']['03']['env'] = ["#9E00FF"];
        this.themes['15']['03']['clo'] = ["#fff", "#000"];
        this.themes['15']['03']['head'] = ["#997549"];
        this.themes['15']['03']['mouth'] = ["#EAEAEA", "#D91212"];
        this.themes['15']['03']['eyes'] = ["black", "black", "#FF0000"];
        this.themes['15']['03']['top'] = ["#633a34", "#633a34", "#633a34", "none", "none"];
    ...
    generate(base_array) {
        ...
        var shapes = {
            'env': this.env,
            'head': this.head,
            'clo': this.shapes[base_array[0]]['clo'],
            'mouth': this.shapes[base_array[1]]['mouth'],
            'eyes': this.shapes[base_array[2]]['eyes'],
            'top': this.shapes[base_array[3]]['top'],
        };

        var colors = {
            'env': [this.env_colors[parseInt(base_array[8])]],
            'head': [this.head_colors[parseInt(base_array[9])]],
            'clo': this.themes[base_array[0]][base_array[4]]['clo'],
            'mouth': this.themes[base_array[1]][base_array[5]]['mouth'],
            'eyes': this.themes[base_array[2]][base_array[6]]['eyes'],
            'top': this.themes[base_array[3]][base_array[7]]['top'],
        };

        var svg_array = [];

        for (const [shape_key, shape_val] of Object.entries(shapes)) {
            var svg_string = shape_val;
            var svg_colors = colors[shape_key];

            var regex = /#(.*?);/g;
            var result = svg_string.match(regex);

            var final_svg_string = svg_string;

            if (result != null) {
                for (var i = 0; i < result.length; i++) {
                    final_svg_string = final_svg_string.replace(result[i], svg_colors[i] + ';');
                }
            }

            svg_array.push(final_svg_string);
    ...
    generate_svg(base_array) {
        var svg_parts = this.generate(base_array);
        var final_svg = '';
        final_svg += this.svgStart;
        for (var svgPart of svg_parts) {
            final_svg += svgPart;
        }
        final_svg += this.svgEnd;
        return final_svg;
    }

    generate_svg_byInt(base_int) {
        var base_int_str = '' + base_int;

        // strict comparison
        if (base_int_str.length != (10 * 2) || base_int_str.match(/[^0-9]/g) !== null) {
            return false;
        }

        var base_array = base_int_str.match(/.{1,2}/g);
        if (base_array.length == 10) {
            var all_elements_are_two_characters = true;
            for (const elemento of base_array) {
                if (elemento.length != 2) {
                    all_elements_are_two_characters = false;
                }
            }
            if (
                all_elements_are_two_characters &&

                parseInt(base_array[0]) <= this.shapes_end_key &&
                parseInt(base_array[1]) <= this.shapes_end_key &&
                parseInt(base_array[2]) <= this.shapes_end_key &&
                parseInt(base_array[3]) <= this.shapes_end_key &&
                parseInt(base_array[4]) <= this.colors_end_key &&
                parseInt(base_array[5]) <= this.colors_end_key &&
                parseInt(base_array[6]) <= this.colors_end_key &&
                parseInt(base_array[7]) <= this.colors_end_key &&
                parseInt(base_array[8]) < this.env_colors.length &&
                parseInt(base_array[9]) < this.head_colors.length &&

                parseInt(base_array[0]) >= 0 &&
                parseInt(base_array[1]) >= 0 &&
                parseInt(base_array[2]) >= 0 &&
                parseInt(base_array[3]) >= 0 &&
                parseInt(base_array[4]) >= 0 &&
                parseInt(base_array[5]) >= 0 &&
                parseInt(base_array[6]) >= 0 &&
                parseInt(base_array[7]) >= 0 &&
                parseInt(base_array[8]) >= 0 &&
                parseInt(base_array[9]) >= 0
            ) {
                return this.generate_svg(base_array);
            } else {
                return false;
            }
        } else {
    ...
    getAleatoryAvatarID() {
        ...
        base_array.push(CrafyAvatars_getRandomInt(0, this.shapes_end_key));
        base_array.push(CrafyAvatars_getRandomInt(0, this.shapes_end_key));
        base_array.push(CrafyAvatars_getRandomInt(0, this.shapes_end_key));
        base_array.push(CrafyAvatars_getRandomInt(0, this.shapes_end_key));

        base_array.push(CrafyAvatars_getRandomInt(0, this.colors_end_key));
        base_array.push(CrafyAvatars_getRandomInt(0, this.colors_end_key));
        base_array.push(CrafyAvatars_getRandomInt(0, this.colors_end_key));
        base_array.push(CrafyAvatars_getRandomInt(0, this.colors_end_key));

        base_array.push(CrafyAvatars_getRandomInt(0, this.env_colors.length-1));

        base_array.push(CrafyAvatars_getRandomInt(0, this.head_colors.length-1));

        var base_string = '';

        for (const inumber of base_array) {
            base_string += CrafyAvatars_addZeroToStart(inumber);
        }
    ...
    get_amounts() {
        return {
            ...
            'head_colors': this.head_colors.length,
            'env_colors': this.env_colors.length,
        };
    }

    convertBaseArrayOnBaseInt(base_array) {
        return base_array.join('');
    }

    convertBaseIntOnBaseArray(base_int_str) {
        return base_int_str.match(/.{1,2}/g);
    }
